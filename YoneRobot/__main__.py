...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @CALL_ME_VP \
...
def visa_about_callback(update, context):
    ...
    if query.data == "visa_":
        query.message.edit_text(
            text=""" ℹ️ I'm *visa*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_visa's licensed under the GNU General Public License v3.0_
                 \nHere is the [💾Repository](https://github.com/callmevp/Miss-Visa).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *yone*
                 \nHere is the [Source Code](https://github.com/callmevp/Miss-Visa) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
